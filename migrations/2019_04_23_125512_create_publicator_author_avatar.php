...
class CreatePublicatorAuthorAvatar extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('publicator_author_avatar', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::drop('publicator_author_avatar');
    }
}
