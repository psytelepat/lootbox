...
class CreateContentBlockVideoImage extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('content_block_video_image', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::drop('content_block_video_image');
    }
}
